...
The application is deployed and publicly accessible online at:
🔗 https://cadd-tools.streamlit.app/

## Requirements
This project can be accessed directly through the web link above.
However, if you wish to run the application locally, it was tested with Python 3.9+.

To run it locally, you will need to install the required dependencies:
